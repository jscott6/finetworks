...
RCPP_MODULE(graph_module)
{
    ...
    class_<Graph>("FinNet")
    .constructor<NumericMatrix, NumericMatrix, NumericMatrix, IntegerMatrix, double>("Constructs network from a weight matrix and a Fixed Matrix")
    ...
    .method("debug", &Graph::debug, "Set debug mode on or off")
    ...
    .method("printRows", &Graph::printRows, "Print internal row vertex structures")
    .method("printCols", &Graph::printCols, "Print internal column vertex structures")
    ;
}
